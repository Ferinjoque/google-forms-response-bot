""" Get entries from form 
    ...
    Date: 2023-12-17
"""
#PONER EN CMD: python form.py 'https://docs.google.com/forms/d/e/1FAIpQLSfnGhcqu1iiZbzl5Qp8cGSSS4lmlhS349Ca3BCUG-41GVDCWg/formResponse' -o results.txt
#PAGINA: https://github.com/tienthanh214/googleform-autofill-and-submit
import argparse
import json
import re
...
def parse_form_entries(url: str, only_required = False):
    ...
    def parse_entry(entry):
        ...
        result = []
        if entry[4] is not None:  # Agregar verificación aquí
